...
var FreeService = (function () {
    function FreeService(_confService, _esService) {
        this._confService = _confService;
        this._esService = _esService;
        this._esIndex = "freelances";
        this._esType = "";
    }
    /*
    ...
    * RETURN: Observable
    * */
    FreeService.prototype.searchFreelances = function (searchFilter) {
        var esParams = {
            index: this._esIndex,
            type: this._esType,
